            ...
            while (continue_banking == true)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        string[] accounts = Directory.GetFiles("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Savings Accounts", "*.xml");
                        bool found=false;
                        foreach (var acc in accounts)
                        {
                            found=savObj.DeserializeAcc(acc);
                            Console.WriteLine("Account no. - " + savObj.AccNo);
                            Console.WriteLine("Account Holder name - " + savObj.AccName);
                            Console.WriteLine("Account Type - Savings ");
                            Console.WriteLine("Account Balance - " + savObj.AccBalance);

                            if (savObj.AccIsactive == true)
                            {
                                Console.WriteLine("Is this account active - yes\n\n");
                            }
                            else
                        ...
                        accounts = Directory.GetFiles("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Current Accounts", "*.xml");
                        foreach (var acc in accounts)
                        {
                            found=curObj.DeserializeAcc(acc);
                            Console.WriteLine("Account no. - " + curObj.AccNo);
                            Console.WriteLine("Account Holder name - " + curObj.AccName);
                            Console.WriteLine("Account Type -  Current");
                            Console.WriteLine("Account Balance - " + curObj.AccBalance);

                            if (curObj.AccIsactive == true)
                            {
                                Console.WriteLine("Is this account active - yes\n\n");
                            }
                            else
                        ...
                        PF pfObj = new PF();
                        accounts = Directory.GetFiles("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\PF Accounts", "*.xml");
                        foreach (var acc in accounts)
                        {
                            found=pfObj.DeserializeAcc(acc);
                            Console.WriteLine("Account no. - " + pfObj.AccNo);
                            Console.WriteLine("Account Holder name - " + pfObj.AccName);
                            Console.WriteLine("Account Type -  Savings");
                            Console.WriteLine("Account Balance - " + pfObj.AccBalance);

                            if (pfObj.AccIsactive == true)
                            {
                                Console.WriteLine("Is this account active - yes\n\n");
                            }
                            else
                    ...
                    case 2:
                        ...
                        {
                            case 1:
                                savObj = new Savings(accName, accBalance, accIsactive);
                                break;
                            case 2:
                                curObj = new Current(accName, accBalance, accIsactive);
                                break;
                            case 3:
                                pfObj = new PF(accName, accBalance, accIsactive);
                                break;
                            default:
                                Console.WriteLine("Invalid Choice");
                                break;
                    ...
                    case 3:
                        ...
                        {
                            savObj = new Savings();
                            found=savObj.DeserializeAcc("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Savings Accounts\\" + accNo + ".xml");
                            if (found == true)
                            {
                                Console.WriteLine("Account no. - " + savObj.AccNo);
                                Console.WriteLine("Account Holder name - " + savObj.AccName);
                        ...
                        else if (accNo.StartsWith("CUR"))
                        {
                            curObj = new Current();
                            found = curObj.DeserializeAcc("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Current Accounts\\" + accNo + ".xml");
                            if (found == true)
                            {
                                Console.WriteLine("Account no. - " + curObj.AccNo);
                                Console.WriteLine("Account Holder name - " + curObj.AccName);
                        ...
                        {
                            pfObj = new PF();
                            found=pfObj.DeserializeAcc("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\PF Accounts\\" + accNo + ".xml");
                            if (found == true)
                            {
                                Console.WriteLine("Account no. - " + pfObj.AccNo);
                                Console.WriteLine("Account Holder name - " + pfObj.AccName);
                    ...
                    case 4:
                        ...
                        if(accNo.StartsWith("SAV"))
                        {
                            ...
                            if (found == true)
                            {
                                Console.WriteLine("Enter Amount to be deposited");
                                depositAmount = Convert.ToDouble(Console.ReadLine());
                                depositSuccessful=savObj.Deposit(depositAmount);
                                if (depositSuccessful)
                                {
                                    savObj.SerializeAcc();
                                    Console.WriteLine("\nAmount Deposited .New Balance is " + savObj.AccBalance);
                                }
                            }
                        }
                        else if (accNo.StartsWith("CUR"))
                        {
                            ...
                            if (found == true)
                            {
                                Console.WriteLine("Enter Amount to be deposited");
                                depositAmount = Convert.ToDouble(Console.ReadLine());
                                depositSuccessful = curObj.Deposit(depositAmount);
                                if (depositSuccessful)
                                {
                                    curObj.SerializeAcc();
                                    Console.WriteLine("\nAmount Deposited .New Balance is " + curObj.AccBalance);
                                }
                            }
                        }
                        else
                        {
                            ...
                            if (found == true)
                            {
                                Console.WriteLine("Enter Amount to be deposited");
                                depositAmount = Convert.ToDouble(Console.ReadLine());
                                depositSuccessful=pfObj.Deposit(depositAmount);
                                if (depositSuccessful)
                                {
                                    pfObj.SerializeAcc();
                                    Console.WriteLine("\nAmount Deposited .New Balance is " + pfObj.AccBalance);
                                }
                            }
                        }
                    ...
                    case 5:
                        ...
                        if (accNo.StartsWith("SAV"))
                        {
                            ...
                            if (found == true)
                            {
                                Console.WriteLine("Enter Amount to be withdrawn");
                                withdrawAmount = Convert.ToDouble(Console.ReadLine());
                                withdrawalSuccessful=savObj.Withdraw(withdrawAmount);
                                if (withdrawalSuccessful)
                                {
                                    savObj.SerializeAcc();
                                    Console.WriteLine("\nAmount Withdrawn .New Balance is " + savObj.AccBalance);
                                }
                            }
                        }
                        else if (accNo.StartsWith("CUR"))
                        {
                            ...
                            if (found == true)
                            {
                                Console.WriteLine("Enter Amount to be withdrawn");
                                withdrawAmount = Convert.ToDouble(Console.ReadLine());
                                withdrawalSuccessful= curObj.Withdraw(withdrawAmount);
                                if (withdrawalSuccessful)
                                {
                                    curObj.SerializeAcc();
                                    Console.WriteLine("\nAmount Withdrawn .New Balance is " + curObj.AccBalance);
                                }                            }
                        }
                        else
                        {
                            ...
                            if (found == true)
                            {
                                Console.WriteLine("Enter Amount to be withdrawn");
                                withdrawAmount = Convert.ToDouble(Console.ReadLine());
                                withdrawalSuccessful = pfObj.Withdraw(withdrawAmount);
                                if (withdrawalSuccessful)
                                {
                                    pfObj.SerializeAcc();
                                    Console.WriteLine("\nAmount Withdrawn .New Balance is " + pfObj.AccBalance);
                                }
                            }
                        }
                    ...
                    case 6:
                        ...
                        Console.WriteLine("Enter Account no. of Receiver");
                        string receiveraccNo = Console.ReadLine();
                        bool senderFound = false,transferSuccessful=false;
                        if(senderaccNo.StartsWith("SAV"))
                        {
                            Savings senderObj = new Savings();
                            senderFound = senderObj.DeserializeAcc("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Savings Accounts\\" + senderaccNo + ".xml");
                            if (senderFound)
                            {
                                transferSuccessful=senderObj.Transfer(receiveraccNo);
                                senderObj.SerializeAcc();
                            }
                        }
                        else if (senderaccNo.StartsWith("CUR"))
                        {
                            Current senderObj = new Current();
                            senderFound = senderObj.DeserializeAcc("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Current Accounts\\" + senderaccNo + ".xml");
                            if (senderFound)
                            {
                                transferSuccessful = senderObj.Transfer(receiveraccNo);
                                senderObj.SerializeAcc();
                        ...
                        {
                            PF senderObj = new PF();
                            senderFound = senderObj.DeserializeAcc("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\PF Accounts\\" + senderaccNo + ".xml");
                            if (senderFound)
                            {
                                transferSuccessful=senderObj.Transfer(receiveraccNo);
                                senderObj.SerializeAcc();
                    ...
                    case 7:
                        ...
                        savObj = new Savings();
                        accounts = Directory.GetFiles("C:\\Users\\varsha\\source\\repos\\Training-DotNet\\Project\\Accounts\\Savings Accounts", "*.xml");
                        found = false;
                        foreach (var acc in accounts)
                        {
                            found = savObj.DeserializeAcc(acc);
