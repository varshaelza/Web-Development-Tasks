            ...
            while (continue_banking == true)
            {
                ...
                switch (choice)
                {
                    ...
                    case 2:
                        ...
                        {
                            case 1:
                                Savings savObj = new Savings(accNo, accName, accBalance, accIsactive);
                                savList.Add(savObj);
                                break;
                            case 2:
                                Current curObj = new Current(accNo, accName, accBalance, accIsactive);
                                curList.Add(curObj);
                                break;
                            case 3:
                                PF pfObj = new PF(accNo, accName, accBalance, accIsactive);
                                pfList.Add(pfObj);
                                break;
                            default:
                    ...
                    case 6:
                        ...
                        if (senderFound == true&&withdrawn==true)
                        {
                            foreach (Savings acc in savList)
                            {
                                if (acc.AccNo == receiveraccNo)
