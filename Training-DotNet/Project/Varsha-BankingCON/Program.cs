                ...
                try
                {
                    ...
                    switch (choice)
                    {
                        case 1:
                            ...
                            var accounts = Directory.GetFiles("C:\\Users\\vgikku\\OneDrive-SOTI Inc\\Training - DotNet\\Project\\Accounts\\Savings Accounts", "*.xml").Select(f => Path.GetFileNameWithoutExtension(f));
                            bool found = false;
                            ...
                            accounts = Directory.GetFiles("C:\\Users\\vgikku\\OneDrive - SOTI Inc\\Training-DotNet\\Project\\Accounts\\Current Accounts", "*.xml").Select(f => Path.GetFileNameWithoutExtension(f)); ;
                            foreach (var acc in accounts)
                            {
                            ...
                            PF pfObj = new PF();
                            accounts = Directory.GetFiles("C:\\Users\\vgikku\\OneDrive - SOTI Inc\\Training-DotNet\\Project\\Accounts\\PF Accounts", "*.xml").Select(f => Path.GetFileNameWithoutExtension(f)); ;
                            foreach (var acc in accounts)
                            {
                        ...
                        case 3:
                            ...
                            try
                            {
                                ...
                                {
                                    savObj = new Savings();
                                    found = savObj.DeserializeAcc(accNo);
                                    if (found == true)
                                    {
                                        Console.WriteLine("Account no. - " + savObj.AccNo);
                                        Console.WriteLine("Account Holder name - " + savObj.AccName);
                                ...
                                {
                                    curObj = new Current();
                                    found = curObj.DeserializeAcc(accNo);
                                    if (found == true)
                                    {
                                        Console.WriteLine("Account no. - " + curObj.AccNo);
                                        Console.WriteLine("Account Holder name - " + curObj.AccName);
                                ...
                                {
                                    pfObj = new PF();
                                    found = pfObj.DeserializeAcc(accNo);
                                    if (found == true)
                                    {
                                        Console.WriteLine("Account no. - " + pfObj.AccNo);
                                        Console.WriteLine("Account Holder name - " + pfObj.AccName);
                        ...
                        case 6:
                            ...
                            try
                            {
                                if (senderaccNo.StartsWith("SAV"))
                                {
                                    ...
                                    senderFound = senderObj.DeserializeAcc(senderaccNo);
                                    if (senderFound)
                                    {
                                        flag = true;
                        ...
                        case 7:
                            ...
                            savObj = new Savings();
                            accounts = Directory.GetFiles("C:\\Users\\vgikku\\OneDrive - SOTI Inc\\Training-DotNet\\Project\\Accounts\\Savings Accounts", "*.xml").Select(f => Path.GetFileNameWithoutExtension(f)); ;
                            found = false;
                            foreach (var acc in accounts)
                            {
                                found = savObj.DeserializeAcc(acc);
                        ...
                        case 8:
                            ...
                            curObj = new Current();
                            accounts = Directory.GetFiles("C:\\Users\\vgikku\\OneDrive - SOTI Inc\\Training-DotNet\\Project\\Accounts\\Current Accounts", "*.xml").Select(f => Path.GetFileName(f)); ;
                            foreach (var acc in accounts)
                            {
                                found = curObj.DeserializeAcc(acc);
                                if (!curObj.AccIsactive)
                            ...
                            pfObj = new PF();
                            accounts = Directory.GetFiles("C:\\Users\\vgikku\\OneDrive - SOTI Inc\\Training-DotNet\\Project\\Accounts\\PF Accounts", "*.xml").Select(f => Path.GetFileName(f)); ;
                            foreach (var acc in accounts)
                            {
                                found = pfObj.DeserializeAcc(acc);
                                if (!pfObj.AccIsactive)
